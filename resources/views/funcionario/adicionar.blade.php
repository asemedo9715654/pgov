    ...
    <div class="col-md-10 col-md-offset-1">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                {!! Form::open(array('url' => '/adicionar_na_base_de_dados', 'method'=>'PATCH','files'=>true))  !!}
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group {{$errors->has('matricula')?'has-error':''}}">
                            ...
                            <?php $cesta = array(); ?>
                            @foreach($veiculos as $category)
                                <?php array_push($cesta,$category->matricula); ?>
                            @endforeach
                            {!! Form::select('matricula', $cesta, null, ['class' => 'form-control']) !!}
